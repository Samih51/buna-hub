...
-- --------------------------------------------------
-- Date Created: 11/17/2023 14:33:55
-- Generated from EDMX file: C:\Users\Sami\Desktop\Buna Hub\Ecommerce\OnlineShoppingStore\DAL\Model1.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK__Tbl_Cart__Produc__24927208]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tbl_Cart] DROP CONSTRAINT [FK__Tbl_Cart__Produc__24927208];
GO
IF OBJECT_ID(N'[dbo].[FK__Tbl_Produ__Categ__25869641]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tbl_Product] DROP CONSTRAINT [FK__Tbl_Produ__Categ__25869641];
GO
IF OBJECT_ID(N'[dbo].[FK__Tbl_Shipp__Membe__267ABA7A]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tbl_ShippingDetails] DROP CONSTRAINT [FK__Tbl_Shipp__Membe__267ABA7A];
GO
...
ALTER TABLE [dbo].[Tbl_Cart]
ADD CONSTRAINT [FK__Tbl_Cart__Produc__24927208]
...
-- Creating non-clustered index for FOREIGN KEY 'FK__Tbl_Cart__Produc__24927208'
CREATE INDEX [IX_FK__Tbl_Cart__Produc__24927208]
ON [dbo].[Tbl_Cart]
    ([ProductId]);
GO
...
ALTER TABLE [dbo].[Tbl_Product]
ADD CONSTRAINT [FK__Tbl_Produ__Categ__25869641]
...
-- Creating non-clustered index for FOREIGN KEY 'FK__Tbl_Produ__Categ__25869641'
CREATE INDEX [IX_FK__Tbl_Produ__Categ__25869641]
ON [dbo].[Tbl_Product]
    ([CategoryId]);
GO
